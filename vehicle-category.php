	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Vehicle Rate Management</li>
			</ol>
		</div><!--/.row-->
		...
		<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">Rate Management </div>
        ...
        <thead>
            <tr>
                ...
                <th>Company Name</th>
                <th>Parking Place</th>
                <th>Two Wheeler Rate</th>
                <th>Three Wheeler Rate</th>
                <th>Four Wheeler Rate</th>
                <th>Actions</th>
        ...
        ?>
            ...
            <td><?php  echo $row['ThreeWheeler'];?></td>
            <td><?php  echo $row['FourWheeler'];?></td>
