<?php
    ...
    if(isset($_POST['submit-in'])){
        ...
        $queryss=mysqli_query($con, "UPDATE vehicle_info set Status='$status',ParkingCharge='$parkingcharge' ,RemoveBy='$nameh' where ID='$cid' and Status=' ' ");
                        
        if ($queryss)
        {
            

                $msg="Submited For Outgoing";
                        ...
                        <div class="col-md-12">
                            ...
                            ?> 
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?php  echo $row['Parkingplace'];?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <?php 
                                      ...
                                      $ret=mysqli_query($con," SELECT ID,HOUR(TIMEDIFF(CURRENT_TIMESTAMP(),InTime)) as abc,VehicleCategory,Parkingplace from vehicle_info where ID='$cid' and Status='' ");
                                      $row=mysqli_fetch_array($ret);
                                      $total=$row['abc'];
                                      $place=$row['Parkingplace'];
                              ...
                              $quel=mysqli_query($con,"SELECT * from location WHERE Location='$place' ");
