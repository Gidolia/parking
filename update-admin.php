<?php
    ...
    $eid=$_GET['editid'];
        ...
        $query=mysqli_query($con, "UPDATE admin set Role='$role',Slot='$slot', UserName='$username', MobileNumber='$mobilenum',Email='$email', Password='$password',Address='$address'  where ID='$eid'");
        if ($query) {
        $msg=" Details Updated.";
					...
					<div class="panel-body">
						...
						<em class='fa fa-lg fa-close'>
                            ...
                            ?>  
								...
								<div class="form-group">
									<label>Role</label>
									<input type="text" class="form-control" value="<?php  echo $row['Role'];?>" id="role" name="role" required>
								</div>
								<div class="form-group">
									<label>Parking Place</label>
									<input type="text" class="form-control" value="<?php  echo $row['Slot'];?>" id="slot" name="slot" required>
								</div>
								
								<div class="form-group">
									<label>Mobile Number</label>
									<input type="text" class="form-control"  value="<?php  echo $row['MobileNumber'];?>" maxlength="10"
                                pattern="[0-9]+" id="mobnum" name="mobnum" required>
								</div>
								<div class="form-group">
									<label>Email</label>
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" value="<?php  echo $row['Password'];?>" id="password" name="password" required>
								</div>
