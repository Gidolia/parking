		...
		<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">Vehicle Categories <a href="add-category_p.php" type="button" class="btn btn-sm btn-primary">Add New Vehicle Category</a></div>
