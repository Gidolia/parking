		...
		<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
                        ...
                        <form method="POST" enctype="multipart/form-data" name="datereports" action="generate-reports_p.php">
                                ...
                                <em class='fa fa-lg fa-close'>
									...
									<div class="col-lg-12">
                                        <label for="">Name</label>
                                            <input class="form-control" type="text" placeholder="Enter Name" name="nameh" id="nameh" required="true">
                                        </div>
