<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="<?php if($page=="adminpannel") {echo "active";}?>"><a href="adminpannel.php"><em class="fa fa-adn">&nbsp;</em> Admin Pannel</a></li>	
			<li class="<?php if($page=="show-admin") {echo "active";}?>"><a href="show-admin.php"><em class="fa fa-address-book">&nbsp;</em> Show Admin</a></li>	
			<li class="<?php if($page=="vehicle-category") {echo "active";}?>"><a href="vehicle-category.php"><em class="fa fa-th-large">&nbsp;</em> Parking Place</a></li>
			...
			<li class="<?php if($page=="monthly-pass") {echo "active";}?>"><a href="monthlypass.php"><em class="fa fa-address-card-o ">&nbsp;</em> Monthly Pass</a></li>
			<li class="<?php if($page=="activepass") {echo "active";}?>"><a href="activepass.php"><em class="fa fa-address-card ">&nbsp;</em> Active Pass</a></li>
