...
<body>
  ...
  <option value="Vendor">Vendor</option>
                        ...
                        <div class="form-group">
                            <label>Email</label>
                            <input type="text" class="form-control" placeholder="Enter Here.." id="Emailid"
                                name="Emailid" required>
                        </div>

                        <div class="form-group">
                            <label>Address</label>
                            <input type="text" class="form-control" placeholder="Enter Here.." id="address"
