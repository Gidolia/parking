<?php
    ...
    $eid=$_GET['editid'];
        ...
        $query=mysqli_query($con, "UPDATE admin set Role='$role', UserName='$username', MobileNumber='$mobilenum',Email='$email', Password='$password',Address='$address'  where ID='$eid'");
        if ($query) {
        $msg="Admin Details has been updated.";
    }
    else
        {
					...
					<div class="panel-body">
						...
						<em class='fa fa-lg fa-close'>
                            ...
                            <input  type="text" class="form-control" id="role" name="role"  value="<?php  echo $row['Role'];?>" required>
                                ...
                                pattern="[0-9]+" value="<?php  echo $row['MobileNumber'];?>" id="mobnum" name="mobnum" required>
								</div>
								<div class="form-group">
									<label>Email</label>
