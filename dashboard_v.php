...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		$dataname=$_SESSION['slothe'];
		 ...
		 $ret=mysqli_query($con,"SELECT count(ID) id1 from vehicle_info Where Parkingplace='$dataname' and Status=''");
		 $row5=mysqli_fetch_array($ret);
		 
		 $ret=mysqli_query($con,"SELECT count(ID) id2 from vehicle_info Where Parkingplace='$dataname' and Status='Out'");
		  $row6=mysqli_fetch_array($ret);

		  $ret=mysqli_query($con,"SELECT count(ID) as id1 from vehicle_info Where Parkingplace='$dataname' and VehicleCategory='Two Wheeler'");
		$row=mysqli_fetch_array($ret);  
             
		$ret=mysqli_query($con,"SELECT count(ID) as id2 from vehicle_info Where Parkingplace='$dataname' and VehicleCategory='Four Wheeler'");
		$row2=mysqli_fetch_array($ret); 

		$ret=mysqli_query($con,"SELECT count(ID) as id4 from vehicle_info Where Parkingplace='$dataname' and VehicleCategory='Three Wheeler'");
