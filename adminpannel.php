<?php
	...
	if(isset($_POST['submit-vehicle'])) {
		...
		$query=mysqli_query($con, "INSERT into admin(Role,Slot,UserName,MobileNumber,Email,Password,Address) value('$role','$sloth','$username','$usercon','$userid','$passwordh','$address')");
		if ($query) {
...
<body>
  ...
  <option value="Vendor">Vendor</option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Enter Password" id="Passwordh"
                                name="Passwordh" required>
                        </div>
                        ...
                        <select class="form-control"  id="Sloth" name="Sloth" >
                        ...
                        <div class="form-group">
                            <label>Contact</label>
                            <input type="text" class="form-control"  placeholder="Enter Number" maxlength="10"
                                pattern="[0-9]+" id="UserCon" name="UserCon" required>
                        </div>

                        <div class="form-group">
                            <label>Email</label>
                            <input type="text" class="form-control"  placeholder="Enter Email" id="Emailid"
