...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        $ret=mysqli_query($con,"SELECT * from vehicle_info Where Parkingplace='$dataname' and Status='Out'");
        $cnt=1;
        ...
        ?>
            ...
            <td>
            <a href="print-receipt_v.php?vid=<?php echo $row['ID'];?>"><button type="button" class="btn btn-sm btn-warning"> <i class="fa fa-print"></i></button>
            </td>
