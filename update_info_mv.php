<?php
    ...
    if(isset($_POST['update-category']))
    {
       ...
       $eid=$_GET['editid'];
        ...
        $query=mysqli_query($con, "UPDATE monthly_pass set RegistrationNumber='$num',VehicleCompanyname='$vehcomp',VehicleCategory='$catename', OwnerName='$ownername',OwnerContactNumber='$ownercontno', FromDate='$fromdate', ToDate='$todate', Charge='$charge' where Location='$dataname' and ID='$eid'");
        if ($query) {
						...
						<em class='fa fa-lg fa-close'>
                            ...
                            ?>  
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" value="<?php  echo $row['VehicleCompanyname'];?>" id="vehcomp" name="vehcomp" required>
								</div>
								...
								<div class="form-group">
									...
									<input type="number" class="form-control" value="<?php  echo $row['OwnerContactNumber'];?>" maxlength="10" pattern="[0-9]+" id="ownercontno" name="ownercontno" required>
								</div>
