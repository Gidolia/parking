<?php
    ...
    if(isset($_POST['submit-in'])){
        ...
        $query=mysqli_query($con, "UPDATE $dataname set Remark='$remark',Status='$status',ParkingCharge='$parkingcharge' where ID='$cid'");
        if ($query) {
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
                        ...
                        <div class="col-md-12">
                            ...
                            $cid=$_GET['updateid'];
							$dataname=$_SESSION['slothe'];
                            $ret=mysqli_query($con,"SELECT * from $dataname where ID='$cid'");
                            $cnt=1;
                            ...
                            ?> 
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" value="<?php  echo $row['VehicleCategory'];?>" id="catename" name="catename" readonly>
								</div>
                                ...
                                <div class="form-group">
									<label>Charge</label>
									<input type="text" name="status" value="<?php echo $row['ParkingCharge']; ?>" class="form-control" readonly>
								</div>
