...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        ?>
            ...
            <td>   <a href="print.php?vid=<?php echo $row['ID'];?>"><button type="button" class="btn btn-sm btn-warning"> <i class="fa fa-print"></i></button>
			<a href="update_info.php?editid=<?php echo $row['ID'];?>"> <button class="btn btn-success btn-sm"><i class="fa fa-edit"></i></button> </a>
            </td>
